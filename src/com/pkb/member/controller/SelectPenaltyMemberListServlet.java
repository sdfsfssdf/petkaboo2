...
/**
 * Servlet implementation class SelectPenaltyMemberListServlet
 */
@WebServlet("/selectPenaltyList.me")
public class SelectPenaltyMemberListServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public SelectPenaltyMemberListServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// 전체 목록 갯수를 리턴받음
		pg.setListCount(new UserService().getPenaltyMemberCount());
		...
		HashMap<String,Object> pMap = new UserService().selectPenaltyMemberList(pg.getCurrentPage(), pg.getLimit());

		String page = "";
		if (pMap != null) {
			page = "views/admin/memberManage/memberPenalty.jsp";
			request.setAttribute("pMap", pMap);
			request.setAttribute("pg", pg);
		} else {
			page = "views/common/errorPage.jsp";
			request.setAttribute("msg", "(관리자 페이지)회원 제재/탈퇴 목록 조회 실패");
		}
