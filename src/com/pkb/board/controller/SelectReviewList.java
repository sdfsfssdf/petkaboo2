 ...
 */
@WebServlet("/selectReviewList.bo")
public class SelectReviewList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		ArrayList<Board> list = new BoardService().selectReviewList(pg.getCurrentPage(), pg.getLimit(), user_no);
		...
		if(list != null){
			...
			request.setAttribute("msg", "내 후기 조회 실패");
