...
<body>
	...
	<div class="contentArea">
		...
		<form action="<%=request.getContextPath()%>/oneModifyForm.bo"
			method="post">
			<h2>1:1문의 작성하기</h2>
			...
			<div class="topView">
				...
				&nbsp;&nbsp; <label class="labelTitle">제목</label> <input type="text"
					...
					value="<%=b.getArticle_title()%>" readOnly>
				<!-- 받아온 정보를 넣어야함.-->

				<br> <br> <label>작성자 </label> <input type="text"
					class="form-control writer" id="detailwriter"
					value="<%=b.getUser_name()%>" readOnly>
				&nbsp;&nbsp;&nbsp;&nbsp; <label>작성일</label> <input type="text"
					class="form-control date" id="detaildate"
			...
			<div class="content">
				<textarea class="form-control" rows="20" cols="30" id="comment"
					value="" style="background-color:white;"readOnly><%=b.getArticle_contents()%></textarea>
			</div>
			<br>
